...
export const rentalPlanSchema = z.enum(["15d", "1mo", "1yr", "2yr"]);

// Global site-wide prices (null = plan disabled / not for sale).
...
export const siteSettingsSchema = z.object({
  price15dCents: priceCents,
  price1moCents: priceCents,
  price1yrCents: priceCents,
  price2yrCents: priceCents,
});
...
export const grantSubscriptionSchema = z.object({
  ...
  plan: rentalPlanSchema.default("1mo"),
});
...
const optionalImageUrl = safeUrl.nullable().optional().or(z.literal("").transform(() => null));
